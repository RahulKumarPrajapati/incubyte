const calculator = require('./string_calculator');
...
test("Test Case 7 -> If string contains a negative number", () => {
    expect(calculator("1,2,-3,4")).toBe("negative numbers not allowed -3")
});
...
// Test Case 9 -> If string contains more than one delimiter
test("Test Case 9 -> If string contains more than one delimiter", () => {
    expect(calculator("//[;][,]\n2;10,3\n4;5\n6")).toBe(30)
});

// Test Case 10 -> If string contains delimiter of length more than 1
test("Test Case 10 -> If string contains delimiter of length more than 1", () => {
    expect(calculator("//[***]\n1***2***3")).toBe(6)
});

// Test Case 11 -> If string contains more than one delimiter of length more than 1
test("Test Case 11 -> If string contains more than one delimiter of length more than 1", () => {
    expect(calculator("//[**][%%]\n1**2%%3")).toBe(6)
});